...
class App extends Component {
  ...
  handleAddTodo(todo) {
    this.setState({todos: [...this.state.todos, todo]})// this goes with line 32
  }
  render() {
    return (
...
//====--------> this part could be at another folder (it's a component)
        ...
        <div>
          ...
          <form className="form-horizontal" onSubmit={this.handleSubmit}>
            <div className="form-group">
              <label htmlFor="inputTodoResponsible" className="col-sm-2 control-label">Todo</label>
